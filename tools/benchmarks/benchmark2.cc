...
void run(const vector<cv::String> &images) {
    ...
    cout << "OpenCV runtime (CPU) - Resize Average: " << totalTimeResize / loadedImages.size() << " nanoseconds" << endl;
...
void runCUDA(const vector<cv::String> &images) {
    ...
    cout << "OpenCV runtime (GPU) - Resize Average: " << totalTimeResize / loadedImages.size() << " nanoseconds" << endl;
